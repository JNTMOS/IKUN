...
c0102ab8:	89 45 e8             	mov    %eax,-0x18(%ebp)
            p->property = page->property - n; //剩下的第一个页成了基页
...
c0102ae5:	90                   	nop
            list_add_after(&(page->page_link), &(p->page_link));//修改链表结构
...
c0102cb8:	89 45 f0             	mov    %eax,-0x10(%ebp)
        // TODO: optimize
        if (base + base->property == p) { //恰好和后面合并
...
c0102d32:	eb 7d                	jmp    c0102db1 <default_free_pages+0x225>
        ...
        else if (p + p->property == base) { //恰好和前面合并
...
c0103e50:	68 de 00 00 00       	push   $0xde
...
//第二次遍历物理内存，这一次遍历，主要是调用init_memmap初始化各个页表。
            if (begin < freemem) {
...
c0104000:	68 fd 00 00 00       	push   $0xfd
...
c0104090:	68 03 01 00 00       	push   $0x103
...
c01040ef:	68 0f 01 00 00       	push   $0x10f
...
c010412d:	68 19 01 00 00       	push   $0x119
...
c0104176:	68 2f 01 00 00       	push   $0x12f
...
#endif
    pde_t *pdep = &pgdir[PDX(la)]; //在一级页表里去查
...
c01041f3:	0f 85 9f 00 00 00    	jne    c0104298 <get_pte+0xca>
        struct Page *page;
        if (!create || (page = alloc_page()) == NULL) { //不想创建或没可分配的物理页了 
...
c010421a:	e9 ca 00 00 00       	jmp    c01042e9 <get_pte+0x11b>
        ...
        set_page_ref(page, 1); //抓了一个空页当二级页表 ref+1
...
c010423d:	89 45 ec             	mov    %eax,-0x14(%ebp)
        memset(KADDR(pa), 0, PGSIZE); //对应位置内存全填0 因为页表还是空的
...
c0104261:	68 75 01 00 00       	push   $0x175
...
c0104288:	83 c4 10             	add    $0x10,%esp
        *pdep = pa | PTE_U | PTE_W | PTE_P; //赋权 并且把入口地址放在一级页表里
...
c01042c0:	68 78 01 00 00       	push   $0x178
...
c0104351:	74 50                	je     c01043a3 <page_remove_pte+0x62>
        struct Page *page = pte2page(*ptep); //找到二级表项对应的物理页的位置
...
c0104364:	89 45 f4             	mov    %eax,-0xc(%ebp)
        if (page_ref_dec(page) == 0) { //引用位-1 为0就可以直接释放
...
c01044be:	68 da 01 00 00       	push   $0x1da
...
c0104528:	68 e7 01 00 00       	push   $0x1e7
...
c0104558:	68 e8 01 00 00       	push   $0x1e8
...
c010458a:	68 e9 01 00 00       	push   $0x1e9
...
c01045cc:	68 ed 01 00 00       	push   $0x1ed
...
c0104603:	68 f0 01 00 00       	push   $0x1f0
...
c0104632:	68 f1 01 00 00       	push   $0x1f1
...
c010465e:	68 f2 01 00 00       	push   $0x1f2
...
c0104697:	68 f4 01 00 00       	push   $0x1f4
...
c01046db:	68 f5 01 00 00       	push   $0x1f5
...
c0104720:	68 f8 01 00 00       	push   $0x1f8
...
c010475a:	68 f9 01 00 00       	push   $0x1f9
...
c010477f:	68 fa 01 00 00       	push   $0x1fa
...
c01047a4:	68 fb 01 00 00       	push   $0x1fb
...
c01047cb:	68 fc 01 00 00       	push   $0x1fc
...
c01047f7:	68 fd 01 00 00       	push   $0x1fd
...
c010482c:	68 ff 01 00 00       	push   $0x1ff
...
c0104858:	68 00 02 00 00       	push   $0x200
...
c0104883:	68 01 02 00 00       	push   $0x201
...
c01048bd:	68 02 02 00 00       	push   $0x202
...
c01048ec:	68 03 02 00 00       	push   $0x203
...
c0104911:	68 04 02 00 00       	push   $0x204
...
c0104950:	68 07 02 00 00       	push   $0x207
...
c010497b:	68 08 02 00 00       	push   $0x208
...
c01049bc:	68 0b 02 00 00       	push   $0x20b
...
c01049e7:	68 0c 02 00 00       	push   $0x20c
...
c0104a24:	68 0e 02 00 00       	push   $0x20e
...
c0104aa5:	68 1a 02 00 00       	push   $0x21a
...
c0104ae5:	68 1a 02 00 00       	push   $0x21a
...
c0104b11:	68 1b 02 00 00       	push   $0x21b
...
c0104b63:	68 1e 02 00 00       	push   $0x21e
...
c0104b88:	68 1e 02 00 00       	push   $0x21e
...
c0104bac:	68 20 02 00 00       	push   $0x220
...
c0104bf1:	68 24 02 00 00       	push   $0x224
...
c0104c1d:	68 25 02 00 00       	push   $0x225
...
c0104c52:	68 26 02 00 00       	push   $0x226
...
c0104c7e:	68 27 02 00 00       	push   $0x227
...
c0104cca:	68 2b 02 00 00       	push   $0x22b
...
c0104d0d:	68 2e 02 00 00       	push   $0x22e
